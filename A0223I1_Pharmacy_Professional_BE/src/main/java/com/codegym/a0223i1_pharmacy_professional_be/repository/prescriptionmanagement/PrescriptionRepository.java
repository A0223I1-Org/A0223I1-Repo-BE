package com.codegym.a0223i1_pharmacy_professional_be.repository.prescriptionmanagement;
...
public interface PrescriptionRepository extends JpaRepository<Prescription, String> {
    ...
    @Query(value = "SELECT id, name, target, note, treatment_period, delete_flag, symptom_id  " +
            "FROM prescription p " +
